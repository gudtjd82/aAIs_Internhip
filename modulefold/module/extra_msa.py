...
class ExtraMSAStackBlock(torch.nn.Module):
    ...
    def forward(self, e, z, msa_mask, pair_mask):
        ...
        e_ = self.dropout_row_msa(self.msa_row_attn(e, z, msa_mask))
        e = e + e_
        e_ = self.msa_col_attn(e, msa_mask)
        e = e + e_
        e_ = self.msa_transition(e, msa_mask)
        e = e + e_
        z_ = self.outer_product_mean(e, msa_mask)
        z = z + z_
